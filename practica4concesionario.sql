CREATE TABLE autom?tico (
    modelo_autom?tico VARCHAR2(5) NOT NULL,
    modelo_modelo_id  NUMBER NOT NULL
);

CREATE UNIQUE INDEX autom?tico__idx ON
    autom?tico (
        modelo_modelo_id
    ASC );
...
CREATE TABLE compradores (
    ...
    tel?fono NUMBER(9) NOT NULL
);
UPDATE  compradores SET dni='p253456v'  WHERE dni='x123456v';
DELETE FROM compradores WHERE tel?fono=123456789;
COMMIT;
...
CREATE TABLE concesionario (
    ...
    c?digo_postal NUMBER(6) NOT NULL,
    tel?fono      NUMBER(9) NOT NULL,
    PRIMARY KEY (ciudad)
);
UPDATE  concesionario SET tel?fono=680951227  WHERE tel?fono=623456530;
DELETE FROM concesionario WHERE tel?fono=623456530;
COMMIT;
...
UPDATE  empresa SET tel?fono=952411706  WHERE tel?fono=888123456;
DELETE FROM empresa WHERE tel?fono=888123456 ;
COMMIT;
...
UPDATE  vendedores SET tel?fono=952411708  WHERE tel?fono=677123456;
DELETE FROM vendedores WHERE tel?fono=677123456;
COMMIT;

ALTER TABLE autom?tico
    ADD CONSTRAINT autom?tico_modelo_fk FOREIGN KEY ( modelo_modelo_id )
...
CREATE OR REPLACE TRIGGER arc_arc_1_autom?tico BEFORE
    INSERT OR UPDATE OF modelo_modelo_id ON autom?tico
    FOR EACH ROW
DECLARE
    d CHAR(3);
BEGIN
    ...
    IF ( d IS NULL OR d <> 'AUT' ) THEN
        raise_application_error(-20223, 'FK AUTOM?TICO_MODELO_FK in Table AUTOM?TICO violates Arc constraint on Table MODELO - discriminator column TIPO_CAJA doesn''t have value ''AUT'''
        );
    END IF;
...
--CONCESIONARIO--
INSERT INTO concesionario(tel?fono,c?digo_postal,ciudad)VALUES(623456530, 29130,'Mala');
INSERT INTO concesionario(tel?fono,c?digo_postal,ciudad)VALUES(695447511, 29001,'Sevi');
INSERT INTO concesionario(tel?fono,c?digo_postal,ciudad)VALUES(678501466, 28004,'Madr');
INSERT INTO concesionario(tel?fono,c?digo_postal,ciudad)VALUES(952411750, 26104,'Vale');
INSERT INTO concesionario(tel?fono,c?digo_postal,ciudad)VALUES(680952488, 38204,'Barc');

--VENDEDORES--
INSERT INTO vendedores(nombre,apellido,tel?fono,dni,concesionario_ciudad)VALUES('Salvi','Perez',677123456,'x777777v','Mala');
INSERT INTO vendedores(nombre,apellido,tel?fono,dni,concesionario_ciudad)VALUES('Danie','Garci',666123456,'c555556a','Sevi');
INSERT INTO vendedores(nombre,apellido,tel?fono,dni,concesionario_ciudad)VALUES('Samue','Lunas',888123456,'q999999v','Madr');
INSERT INTO vendedores(nombre,apellido,tel?fono,dni,concesionario_ciudad)VALUES('Santi','Gomez',777524333,'a452345p','Vale');
INSERT INTO vendedores(nombre,apellido,tel?fono,dni,concesionario_ciudad)VALUES('Frank','Lopez',958123456,'q111111v','Barc');


--COMPRADORES--
INSERT INTO compradores(dni,nombre,apellido,tel?fono)VALUES('x123456v','Danie','Perez',123456789);
INSERT INTO compradores(dni,nombre,apellido,tel?fono)VALUES('x234567v','Frank','Gucci',452173389);
INSERT INTO compradores(dni,nombre,apellido,tel?fono)VALUES('n123456y','Samue','Garci',826456789);
INSERT INTO compradores(dni,nombre,apellido,tel?fono)VALUES('q853456f','Crist','Diazs',555123444);
INSERT INTO compradores(dni,nombre,apellido,tel?fono)VALUES('n124578g','Noeli','Garci',555598766);

--SEGUROS--
INSERT INTO seguro(tipo,precio,tel?fono)VALUES('robos',120,523456789);
INSERT INTO seguro(tipo,precio,tel?fono)VALUES('segur',149,789456654);
INSERT INTO seguro(tipo,precio,tel?fono)VALUES('confr',220,660851227);
INSERT INTO seguro(tipo,precio,tel?fono)VALUES('incen',520,952477105);
INSERT INTO seguro(tipo,precio,tel?fono)VALUES('sinfr',315,952466871);
--COCHE--
...
--EMMPRESA--
INSERT INTO empresa(nombre,tel?fono,localidad)VALUES('bilba',888123456,'malag');
INSERT INTO empresa(nombre,tel?fono,localidad)VALUES('direc',999888777,'madri');
INSERT INTO empresa(nombre,tel?fono,localidad)VALUES('catal',777666555,'valen');
INSERT INTO empresa(nombre,tel?fono,localidad)VALUES('pelay',555444333,'barce');
INSERT INTO empresa(nombre,tel?fono,localidad)VALUES('reale',333222111,'sevil');
